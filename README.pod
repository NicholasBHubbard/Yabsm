...
the I<yabsm> user and group, creates I<yabsms> SSH keys, and creates all the
directories needed for performing the I<snaps>, I<ssh_backups>, and
I<local_backups> defined in C</etc/yabsm.conf>.
