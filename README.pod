...
key based authentication. To achieve this you must add the I<yabsm> users SSH
key (available via C<# yabsm ssh print-key>) to the SSH user's (i.e. larry)
...
The SSH user (i.e. larry) has read and write permission on the backup directory.
