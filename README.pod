...
configuration.
    ...
    yabsm config [check <file?>] [subvols] [snaps] [ssh_backups] [local_backups]
                 [backups] [yabsm_dir] [yabsm_user_home]
...
There are 7 I<immediate_time> forms, the following table denotes the form and gives an example.
...
C<min> is omitted then they are assumed to be 0. C<2020_12_25> is always the same
as C<2020_12_25_00:00> and if the current day is I<2020/12/25> then C<23:59> is
the same as C<2020_12_25_23:59>.
