...
=head2 Initialize Daemon Runtime Environment
...
C</etc/sudoers.d/yabsm-btrfs> that grants the I<yabsm> user passwordless sudo
permission to the C<btrfs> executable.
